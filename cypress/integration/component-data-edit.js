...
suite("component data edit", () => {
  it("should edit data using the decrease button", () => {
    // select Instance
    cy.get(".instance:nth-child(1) .instance:nth-child(2)")
      .eq(0)
      .click();
    cy.get(".data-field")
      .eq(7)
      .find(".actions .vue-ui-button")
      .eq(1)
      .click({ force: true });
  ...
  it("should edit data using the edit input", () => {
    ...
    cy.get(
      ".edit-overlay > .actions > :nth-child(2) > .content > .vue-ui-icon"
    ).click();
  ...
  it("should add elements to array", () => {
    ...
    cy.get(".data-field")
      .eq(6)
      .find(".children .data-field")
      .should("have.length", "3", { timeout: 5000 });
    cy.get(".component-state-inspector").within(() => {
      cy.get(".key")
        .contains("2")
        .parent()
  ...
  it("should remove elements from array", () => {
    ...
    cy.get(".data-field")
      .eq(6)
      .find(".children .data-field")
      .should("have.length", "2", { timeout: 5000 });
  });
  ...
  it("should parse object through edit input", () => {
    ...
    cy.get(".data-field")
      .eq(7)
      .should("contain", "Object", { timeout: 5000 });
    // expand object
    cy.get(".data-field")
      .eq(7)
      .click();
    cy.get(".data-field")
      .eq(8)
      .find(".key")
      .should("contain", "count", { timeout: 5000 });
    cy.get(".data-field")
      .eq(8)
      .find(".value")
      .should("contain", 42, { timeout: 5000 });
  });
  ...
  it("should rename object's property", () => {
    ...
    cy.get(".data-field")
      .eq(8)
      .find(".key")
      .should("contain", "name", { timeout: 5000 });
  });
});
