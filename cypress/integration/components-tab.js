...
suite("components tab", () => {
  ...
  it("should select child instance", () => {
    cy.get(".instance .instance:nth-child(1) .self")
      .eq(0)
      .click();
    ...
    cy.get(".data-el.firebase-bindings .data-field").contains(
      "hello:undefined"
    );
  });

  it("should display prop of different types", () => {
    cy.get(".instance .instance:nth-child(2) .self")
      .eq(0)
      .click();
