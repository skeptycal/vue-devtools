<template>
  <div class="global-preferences preferences">
    <VueFormField title="Normalize component names">
      <VueGroup v-model="$shared.classifyComponents" class="extend">
        <VueGroupButton :value="false" label="Original name" />
        <VueGroupButton :value="true" label="Pascal case" />
      </VueGroup>
    </VueFormField>

    <VueFormField title="Theme">
      <VueGroup v-model="$shared.theme" class="extend">
    ...
    <VueFormField title="Display density">
      <VueGroup v-model="$shared.displayDensity" class="extend">
        <VueGroupButton value="auto" label="Auto" />
