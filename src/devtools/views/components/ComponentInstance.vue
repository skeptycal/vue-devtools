    ...
    >
      ...
      <span class="content">
        ...
        <span v-if="componentHasKey" class="attr">
          <span class="attr-title"> key</span>=<span class="attr-value">{{
            instance.renderKey
          }}</span>
        </span>
      ...
      <span
        ...
        v-tooltip="
          $t('ComponentInstance.consoleId.tooltip', { id: instance.consoleId })
        "
        class="info console"
      >
        = {{ instance.consoleId }}
