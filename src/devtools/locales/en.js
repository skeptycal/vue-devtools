export default {
  ...
  StateInspector: {
    dataType: {
      tooltip:
        "[[{{keys.ctrl}}]] + <<mouse>>: Collapse All<br>[[{{keys.shift}}]] + <<mouse>>: Expand All"
    }
  },
  DataField: {
    edit: {
  ...
  EventsHistory: {
    filter: {
      tooltip:
        "[[{{keys.ctrl}}]] + [[F]] To filter on components, type <input><<search>> &lt;MyComponent&gt;</input> or just <input><<search>> &lt;mycomp</input>."
    },
    clear: {
